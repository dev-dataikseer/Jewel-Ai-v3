...
ATTACH_THEME_LINE_TEMPLATE = "ATTACH_THEME_LINE_TEMPLATE"
ATTACH_LOGO_LINE_TEMPLATE = "ATTACH_LOGO_LINE_TEMPLATE"
...
FRAGMENT_LABELS: dict[str, str] = {
    ...
    ATTACH_THEME_LINE_TEMPLATE: "Attachment — Theme Line Template",
    ATTACH_LOGO_LINE_TEMPLATE: "Attachment — Logo Line Template",
