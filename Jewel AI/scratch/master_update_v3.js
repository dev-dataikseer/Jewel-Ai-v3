...
// 2. Input
const inputTarget = /\{\/\* Input \*\/\}\s*<div className="p-5 min-h-\[360px\] flex flex-col min-w-0">\s*<div className="flex items-center justify-between border-b border-slate-100 pb-2 mb-3 shrink-0">\s*<span className="ui-label mb-0">Input<\/span>[\s\S]*?<\/div>/;
...
// 3. Output
const outputTarget = /\{\/\* Output \*\/\}\s*<div className="p-5 min-h-\[360px\] flex flex-col bg-slate-50\/30">\s*<div className="flex items-center justify-between border-b border-slate-100 pb-2 mb-3">\s*<div className="flex items-center gap-2 min-w-0">\s*<span className="ui-label mb-0">Output<\/span>[\s\S]*?<\/div>\s*<\/div>/;
...
// 4. Closing the generated card, grid, and canvas
...
// 5. Fixing the end of the Generated Card (closing it before ActionDock)
...
console.log("Master Update V3 Successful!");
